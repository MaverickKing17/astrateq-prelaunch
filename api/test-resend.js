...
export default async function handler(req, res) {
  try {
    ...
    console.log("Attempting to send test Astrateq reservation email to kingnarmer702@gmail.com");

    const resolvedTimestamp = new Date().toLocaleString("en-US", { timeZone: "America/Toronto" }) + " EST";
    const amount = "$49.00 CAD";
    const email = "kingnarmer702@gmail.com";
    const selectedTier = "DriveGuard Setup";
