      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto">
          {credibilityPoints.map((point, idx) => (
            <div
              key={idx}
              className="bg-white border-2 border-slate-105 rounded-2.5xl p-6 hover:border-indigo-400 group transition-all duration-300 shadow-sm flex flex-col justify-between text-left"
            >
